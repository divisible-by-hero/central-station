...
MEDIA_ROOT = '/home/dstegelman/static/central-station/media/'

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash.
# Examples: "http://media.lawrence.com/media/", "http://example.com/media/"
MEDIA_URL = 'http://static.centralstationproject.com/central-station/media/'
...
STATIC_URL = 'http://static.centralstationproject.com/central-station/static/'
