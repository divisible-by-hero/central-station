...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profile_userprofile', 'role', self.gf('django.db.models.fields.CharField')(default='dev', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.role'
        db.delete_column('profile_userprofile', 'role')
