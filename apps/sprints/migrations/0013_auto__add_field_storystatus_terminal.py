...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StoryStatus.terminal'
        db.add_column('sprints_storystatus', 'terminal',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StoryStatus.terminal'
        db.delete_column('sprints_storystatus', 'terminal')
