...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StoryStatus'
        db.create_table('sprints_storystatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account'], null=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('sprints', ['StoryStatus'])

        # Adding field 'Story.story_status'
        db.add_column('sprints_story', 'story_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sprints.StoryStatus'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StoryStatus'
        db.delete_table('sprints_storystatus')

        # Deleting field 'Story.story_status'
        db.delete_column('sprints_story', 'story_status_id')
    ...
    models = {
        ...
        'sprints.story': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'story_status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sprints.StoryStatus']", 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True'})
        },
        'sprints.storystatus': {
            'Meta': {'object_name': 'StoryStatus'},
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Account']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
