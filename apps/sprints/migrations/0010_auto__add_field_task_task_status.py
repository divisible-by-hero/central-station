...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.task_status'
        db.add_column('sprints_task', 'task_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sprints.StoryStatus'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.task_status'
        db.delete_column('sprints_task', 'task_status_id')
    ...
    models = {
        ...
        'sprints.story': {
            'Meta': {'ordering': "['story_status']", 'object_name': 'Story'},
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'deleted_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'sprints.storystatus': {
            'Meta': {'ordering': "['order']", 'object_name': 'StoryStatus'},
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Account']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'sprints.task': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'story': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sprints.Story']", 'null': 'True'}),
            'task_status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sprints.StoryStatus']", 'null': 'True', 'blank': 'True'}),
