...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('projects_app', (
            ...
            ('project_manager', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Client'], null=True, blank=True)),
            ('site_url', self.gf('django.db.models.fields.URLField')(max_length=500, null=True, blank=True)),
            ('enable_chats', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('enable_repo', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('enable_issues', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
