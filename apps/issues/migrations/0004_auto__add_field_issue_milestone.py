...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Issue.milestone'
        db.add_column('issues_issue', 'milestone', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.Milestone'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Issue.milestone'
        db.delete_column('issues_issue', 'milestone_id')
