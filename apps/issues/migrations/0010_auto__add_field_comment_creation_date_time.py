...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Comment.creation_date_time'
        db.add_column('issues_comment', 'creation_date_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 3, 6, 13, 44, 6, 344160), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comment.creation_date_time'
        db.delete_column('issues_comment', 'creation_date_time')
