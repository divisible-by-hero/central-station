...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Milestone.app'
        db.add_column('issues_milestone', 'app', self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['projects.App']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Milestone.app'
        db.delete_column('issues_milestone', 'app_id')
