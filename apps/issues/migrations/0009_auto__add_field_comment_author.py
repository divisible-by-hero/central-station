...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('issues_comment', 'author', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comment.author'
        db.delete_column('issues_comment', 'author_id')
